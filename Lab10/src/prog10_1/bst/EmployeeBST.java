...
import prog10_1.employeebst.Employee;
import prog10_1.employeebst.NameComparator;
...
public class EmployeeBST {
	...
	public void insert(Employee x) {
		if (root == null) {
			...
			while(!inserted){
				if(nameCompare.compare(x,n.element)<0) {
				...
				else if(nameCompare.compare(x,n.element)>=0){ 
